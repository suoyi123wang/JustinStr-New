...
public class JUShortConstantExpr extends JUConstantExpr {
    private PossibleParamValueDTO possibleParamValueDTO = null;

    public JUShortConstantExpr(PossibleParamValueDTO possibleParamValueDTO) {
        super();
    ...
    protected String createValue() {
        ...
        return String.valueOf(MagicValues.getShort());
    }
}
