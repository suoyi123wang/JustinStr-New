...
public class JUByteConstantExpr extends JUConstantExpr {
    private PossibleParamValueDTO possibleParamValueDTO = null;

    public JUByteConstantExpr(PossibleParamValueDTO possibleParamValueDTO) {
        super();
    ...
    protected String createValue() {
        ...
        return String.valueOf(MagicValues.getByte());
    }
}
