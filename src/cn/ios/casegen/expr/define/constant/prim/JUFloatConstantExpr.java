...
public class JUFloatConstantExpr extends JUConstantExpr {
    private PossibleParamValueDTO possibleParamValueDTO = null;

    public JUFloatConstantExpr(PossibleParamValueDTO possibleParamValueDTO) {
        super();
    ...
    protected String createValue() {
        if (possibleParamValueDTO != null && !possibleParamValueDTO.getPossibleValue().isEmpty()) {
            return possibleParamValueDTO.getPossibleValue() + "f";
        }
        return MagicValues.getFloat() + "f";
    }
}
